    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50 to-blue-50 pl-64">
      ...
      <div className="p-4 md:p-8 max-w-5xl mx-auto">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          ...
          <p className="text-gray-500 mt-1">Track your learning progress and upcoming modules.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {courses.map((course, index) => (
            <motion.div 
              ...
              className="bg-white/80 backdrop-blur-xl p-6 rounded-3xl shadow-xl border border-white/50 hover:shadow-2xl transition"
            >
              ...
              <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-xl border border-blue-100">
                ...
                <div>
                  <p className="text-xs text-blue-600 font-semibold uppercase">Next Class</p>
                  <p className="text-sm font-bold text-gray-800">{course.nextClass}</p>
                </div>
              </div>
            </motion.div>
          ))}
